...
void main() {
  ...
  group('cacheFirstTimer', () {
    ...
    blocTest<OnBoardingCubit, OnBoardingState>(
        'Should emit [CachingFirstTimer, OnBoardingState] when unsuccessful',
        build: () {
  ...
  group('checkIfUserFirstTimer', () { 
    blocTest<OnBoardingCubit,OnBoardingState>('should emit [CheckingIfUserIsFirstTimer, OnBoardingStatus] when successful',
     build: (){
      when(()=>checkIfUserIsFirstTimer()).thenAnswer((_) async=> Right(false),);
      return cubit;
     },
     ...
     blocTest<OnBoardingCubit,OnBoardingState>('should emit [CheckingIfUserIsFirstTimer, OnBoardingState(true)] when unsuccessful',
     build: (){
