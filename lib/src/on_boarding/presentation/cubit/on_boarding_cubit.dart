...
class OnBoardingCubit extends Cubit<OnBoardingState> {
  ...
  Future<void> cacheFirstTimer() async{
    ...
    result.fold((failure) => OnBoardingError(failure.errorMessage), (_) => const UserCached(),);
  }
  ...
  Future<void> checkIfUserIsFirstTimer() async{
    ...
    result.fold((failure) => emit(const OnBoardingStatus(isFirstTimer: true)), (status) => emit(OnBoardingStatus(isFirstTimer: status)));
  }
}
