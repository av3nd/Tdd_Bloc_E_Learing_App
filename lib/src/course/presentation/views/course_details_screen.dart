...
import 'package:tdd_tutorial_flutter/core/common/widgets/expandable_text.dart';
              ...
              SizedBox(
                ...
                child: Center(
                  child: course.image != null
                      ...
                      : Image.asset(MediaRes.casual_meditation),
                ),
              ),
                ...
                children: [
                  ...
                  if (course.numberOfMaterials > 0 ||
                    ...
                    if (course.numberOfVideos > 0) ...[
                      const SizedBox(height: 10),
                      CourseInfoTile(
                        image: MediaRes.course_info_video,
                    ...
                    if (course.numberOfExams > 0) ...[
                      const SizedBox(height: 10),
                      CourseInfoTile(
                        image: MediaRes.course_info_exam,
                    ...
                    if (course.numberOfMaterials > 0) ...[
                      const SizedBox(height: 10),
                      CourseInfoTile(
                        image: MediaRes.course_info_material,
