...
class AuthenticationCubit extends Cubit<AuthenticationState> {
  ...
  Future<void> createUser({
    ...
    result.fold((failure) => emit(AuthenticatonError(failure.message)), (_) => emit(const UserCreated()));
  } 
  ...
  Future<void> getUsers() async{
    ...
    result.fold((failure) => emit(AuthenticatonError(failure.errorMessage)), (users) => emit(UsersLoaded(users)));
  }
}
